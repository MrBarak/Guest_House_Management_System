...
String radioButtonValue = "";
    ...
    public void setParameter(String[] reg1, String empID)
    {
        this.empID = empID;
            ...
            if(Checks.cnicCheckData(cnic.getText()))
            {
                if(Checks.mobCheckData(mob1.getText()))
                {
                    if(Checks.mobCheckData(mob2.getText()) || mob2.getText().equals(""))
                    {
                        ...
                        {
                            if(Checks.digitCheck((salary.getText())))
                            {
                                if(Integer.parseInt(salary.getText()) >= 20000)
                                {
                            ...
                            //        
                                    ...
                                    label.setText("Salary can NOT be less than 20000!!!");
                            }
                            else
                                label.setText("Salary can only be a Digit Entity!!!");
                        }
                        else
