...
public class RegisterCustomer2Controller implements Initializable 
{
                ...
                if(Checks.alphaCheckIgnoreSpace(country2.getText()) || country2.getText().equals(""))
                {
                    if(Checks.alphaCheckIgnoreSpace(city1.getText()))
                    {
                        if(Checks.alphaCheckIgnoreSpace(city2.getText()) || city2.getText().equals(""))
                        {
                            ...
                            FXMLLoader loader = new FXMLLoader();
                            loader.setLocation(getClass().getResource("RegisterCustomer3.fxml"));
                            Parent tableViewParent = loader.load();
                            ...
                            RegisterCustomer3Controller controller = loader.getController();
